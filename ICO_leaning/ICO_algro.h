...
public:
    ...
    double computeOmega1 (double IMU_T0, double IMU_T_1, double eta);
    double computeDeltaTorque_Speed(double IMU_T0, double IMU_T_1, double eta, double omega2);
    void resetICO();
