...
folder_patterns = [
    ('A7-1/v0.5-Speed/v05-S-*.csv', 'Speed model'),
    ('A7-1/v0.5-ICOSpeed/v05-IS-*.csv', 'ICO Speed control'),
    ('A7-1/v0.5-Torque/v05-T-*.csv', 'Torque model'),
    ('A7-1/v0.5-ICOTorque/v05-IT-*.csv', 'ICO Torque control')
]
