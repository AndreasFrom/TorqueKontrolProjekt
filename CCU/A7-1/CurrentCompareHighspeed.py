...
folder_patterns = [
    ('A7-1/v0.75-Speed/v0.75-S-*.csv', 'S'),
    ('A7-1/v0.75-ICOSpeed/v0.75-IS-*.csv', 'IS'),
    ('A7-1/v0.75-Torque/v0.75-T-*.csv', 'T'),
    ('A7-1/v0.75-ICOTorque/v0.75-IT-*.csv', 'IT')
]
...
plt.title('Average Current Vs control modes v=0.75m/s')
...
for i, label in enumerate(['S', 'IS', 'T', 'IT']):
